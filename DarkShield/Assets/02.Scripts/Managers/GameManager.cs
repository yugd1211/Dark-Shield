...
public partial class GameManager : MonoBehaviour
{
	...
	public void Init()
	{
		EnemyManager newManager = new GameObject("EnemyManager").AddComponent<EnemyManager>();
		newManager.transform.SetParent(transform);
		enemyManager = newManager;
		enemyManager.Init(enemySpawnDatas[0]);
		new GameObject("DialogueManager").AddComponent<DialogueManager>().transform.SetParent(transform);
